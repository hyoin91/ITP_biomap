...
function ShowPop(val) {
    ...
    $('.popup_mask').show();
    Conpop.show();
    Conpop.css('top', Math.max(0,(($(window).height()-$(this).outerHeight())/2) + $(window).scrollTop())+'px');
    Conpop.css('left', Math.max(0,(($(window).width()-$(this).outerWidth())/2) + $(window).scrollLeft())+'px');
return this;
    switch (val) {
        case '0':
